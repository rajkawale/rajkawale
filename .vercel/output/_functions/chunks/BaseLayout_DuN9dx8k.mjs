import { c as createAstro, a as createComponent, d as addAttribute, b as renderTemplate, u as unescapeHTML, m as maybeRenderHead, r as renderComponent, e as renderScript, g as renderSlot, k as renderHead } from './astro/server_DZlb7AaN.mjs';
import 'piccolore';
import 'clsx';
...
const $$Astro$6 = createAstro("https://rajkawale.com");
...
const $$Clarity = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a$2 || (_a$2 = __template$2(["<!-- Load Clarity after CSS to ensure proper styling in recordings and heatmaps --><script>", "<\/script>"])), unescapeHTML(`
...
const $$DesktopHeader = createComponent(($$result, $$props, $$slots) => {
  ...
  Astro2.url.pathname;
  return renderTemplate`<!-- Desktop Header: Split Layout (Logo Left, Menu Right) -->${maybeRenderHead()}<header id="desktop-header" class="desktop-header hidden md:flex fixed top-0 left-0 w-full z-50 px-8 py-6 justify-between items-center bg-transparent transition-all duration-300" data-astro-cid-nfhm5fzu> <!-- Left: Brand Logo - Floating Pill --> <a href="/" id="desktop-logo" class="text-4xl font-serif tracking-tight text-white transition-all duration-300 ease-out flex items-center hover:drop-shadow-[0_0_4px_rgba(255,255,255,0.8)] px-6 py-2 rounded-full border border-white/10 bg-white/5 backdrop-blur-lg shadow-lg shadow-black/5" data-astro-cid-nfhm5fzu> <span class="font-light" data-astro-cid-nfhm5fzu>Raj</span> <span class="font-black" data-astro-cid-nfhm5fzu> Kawale</span> </a> <!-- Right: Navigation Menu + Social Icons - Combined Floating Pill --> <div id="desktop-nav" class="hidden md:flex items-center gap-6 px-6 py-2 rounded-full border border-white/10 bg-white/5 backdrop-blur-lg shadow-lg shadow-black/5 transition-all duration-300" data-astro-cid-nfhm5fzu> <!-- Navigation Links --> <nav class="flex items-center gap-8" data-astro-cid-nfhm5fzu> <a href="/" id="nav-home" class="moonlight-text-link text-base font-medium font-sans text-[#888] hover:text-white transition-all duration-300 ease-out" data-astro-cid-nfhm5fzu>
Home
