/* empty css                                     */
import { c as createAstro, a as createComponent, r as renderComponent, b as renderScript, d as renderTemplate, m as maybeRenderHead, e as addAttribute, F as Fragment, u as unescapeHTML } from '../../chunks/astro/server_D4D8iJOc.mjs';
import 'piccolore';
...
async function getStaticPaths() {
  try {
    ...
    console.log("[getStaticPaths] Post slugs:", validPosts.map((p) => p.slug));
...
Share Article
</a> </div> </div> </div> <footer class="mt-8 border-t border-zinc-800 pt-6" data-astro-cid-4sn4zg3r> ${renderComponent($$result2, "BackNavigation", $$BackNavigation, { "id": "back-navigation-link", "href": "/#writing", "label": "Back to home", "data-astro-cid-4sn4zg3r": true })} </footer> </article> </main> ` })}  ${renderScript($$result, "C:/Users/Raj/Documents/source Code/rajkawale/src/pages/blog/[slug].astro?astro&type=script&index=0&lang.ts")}`;
